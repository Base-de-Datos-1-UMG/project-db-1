...
?>
    ...
    <head>
        ...
        <title>Consultar laboratorios</title>
        <!-- CSS only -->
    ...
    <body class="container">
        ...
        <div class="d-flex align-items-center" style="justify-content: space-between;">
            <h1 class="mt-2 mb-3">Consulta de laboratorios</h1>
        ...
        <table class="table table-striped table-hover ">
            ...
            <tbody>
             ...
             con los nombres de las columnas en la base de datos -->
                ...
                <tr>
                    <th scope="row"><?= $row['IDLABORATORIO']; ?></th>
                    <th><?= $row['NOMBRE_LABORATORIO']; ?></th>
                    <th><?= $row['TELEFONO_LABORATORIO']; ?></th>
                    <th><?= $row['DIRECCION_LABORATORIO']; ?></th>
                    <th><?php echo"<a href='./modificar_laboratorio.php?IDLABORATORIO=".$row['IDLABORATORIO']."'>Editar<a>"; ?></th>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
