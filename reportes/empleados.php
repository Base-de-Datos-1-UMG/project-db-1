<?php
    ...
    class PDF extends FPDF{
        ...
        function ChapterTitle(){
            ...
            $this->Cell(0,10,utf8_decode("Informacion de empleados activos"), 0, 1, 'L', true);
        }
        ...
        $this->Cell(26, 10, "Puesto", 0, 0, "L", 1);
        $this->Cell(18, 10, "Salario", 0, 0, "R", 1);
        ...
        foreach($result as $row){
            ...
            $this->Cell(20,6, $row['IDEMPLEADO'],0,0,'C',$fill);
            ...
            $this->Cell(26,6, $row['PUESTO'],0,0,'L',$fill);
            $this->Cell(18,6, $row['SALARIO'],0,0,'R',$fill);
